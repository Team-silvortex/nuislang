...
use geometry_overlay::{render_geometry_overlay, resolve_geometry_inputs, stamp_line};
use surface_primitives::{
    control_panel_accent, draw_box, draw_card, draw_knob, draw_slider, fill_panel_background,
    fill_rect, put_text, sphere_palette, BoxGlyphs,
};
use texture_sampling::{
    ...
    sample_texture_uv_by_filter, validate_texture_literal,
};
use yir_core::{
    ...
    SurfaceTarget, Value, VertexBuffer, VertexLayout, Viewport,
};
