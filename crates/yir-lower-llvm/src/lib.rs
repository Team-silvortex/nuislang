...
use yir_core::{CpuLlvmLoweringClass, Node, Resource, YirModule};
...
use extern_abi::{
    ...
    lower_i64_extern_arg, render_dynamic_extern_decls, render_extern_call,
};
use loop_expr::{
...
use variant_select::{emit_select_value, emit_variant_is_value, variant_field_value};
#[derive(Clone)]
enum LlvmValueRef {
