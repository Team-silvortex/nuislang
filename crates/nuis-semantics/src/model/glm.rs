use super::{
    NirExpr, NirGlmAccess, NirGlmEffect, NirGlmProfile, NirGlmUseMode, NirGlmValueClass,
    NirMutexCapabilityOp,
};
...
pub fn nir_glm_profile(expr: &NirExpr) -> Option<NirGlmProfile> {
    match expr {
        ...
        NirExpr::CpuMutexCapability { op, .. } => match op {
            ...
            NirMutexCapabilityOp::Permit => Some(NirGlmProfile {
                result_class: NirGlmValueClass::Res,
                accesses: vec![
                    NirGlmAccess {
                        class: NirGlmValueClass::Res,
            ...
            NirMutexCapabilityOp::LeaseValue => Some(NirGlmProfile {
                result_class: NirGlmValueClass::Val,
                accesses: vec![NirGlmAccess {
                    class: NirGlmValueClass::Res,
                    mode: NirGlmUseMode::Read,
            ...
            NirMutexCapabilityOp::LeaseUnlock => Some(NirGlmProfile {
                result_class: NirGlmValueClass::Val,
                accesses: vec![NirGlmAccess {
                    class: NirGlmValueClass::Res,
                    mode: NirGlmUseMode::Own,
