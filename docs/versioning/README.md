...
* what the current mainline should optimize during `alpha-0.10.*`
* which documentation routes and wording are current after the alpha-0.10
  entry refresh
* which broad README surfaces were refreshed for alpha-0.10
