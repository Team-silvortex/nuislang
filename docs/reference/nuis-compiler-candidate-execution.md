...
to `nuis-compiler-candidate-production-v5`. That successor additionally binds
...
the AST and NIR structural-page continuation identities, and the host adapter. See
