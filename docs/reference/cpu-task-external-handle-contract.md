...
That probe is intentionally still invalid today, but its field layout is meant
to hint at a possible future “task-external window handle packet” direction.
