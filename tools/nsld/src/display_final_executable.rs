...
fn print_nsld_final_executable_report_with_title(
    ...
    println!("  final_output_checked: {}", report.final_output_checked);
    ...
    println!(
        ...
        optional_bool_text(report.final_output_image_header_valid)
    );
    println!(
        "  final_output_runnable_candidate: {}",
        optional_bool_text(report.final_output_runnable_candidate)
    );
...
pub(crate) fn print_nsld_final_executable_emit_verify_report(
    ...
    println!(
        ...
        optional_bool_text(report.actual_final_output_checked)
    );
    println!(
    ...
    println!(
        ...
        optional_bool_text(report.actual_final_output_present)
    );
    println!(
        "  expected_final_output_size_bytes: {}",
        optional_usize_text(report.expected_final_output_size_bytes)
    );
    println!(
        "  actual_final_output_size_bytes: {}",
        optional_usize_text(report.actual_final_output_size_bytes)
    );
    println!(
    ...
    println!(
        ...
        optional_bool_text(report.expected_final_output_image_header_valid)
    );
    println!(
        "  actual_final_output_image_header_valid: {}",
        optional_bool_text(report.actual_final_output_image_header_valid)
    );
    println!(
        "  expected_final_output_runnable_candidate: {}",
        optional_bool_text(report.expected_final_output_runnable_candidate)
    );
    println!(
        "  actual_final_output_runnable_candidate: {}",
        optional_bool_text(report.actual_final_output_runnable_candidate)
    );
    println!(
