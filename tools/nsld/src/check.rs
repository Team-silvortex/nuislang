...
pub(crate) fn nsld_check_report(
    ...
    NsldCheckReport {
        ...
        final_executable_output_expected_image_resolver_status: final_snapshot
            .final_executable_output_expected_image_resolver_status,
        final_executable_output_expected_image_patch_application_status: final_snapshot
            .final_executable_output_expected_image_patch_application_status,
        final_executable_output_expected_image_patch_byte_audit_status: final_snapshot
            .final_executable_output_expected_image_patch_byte_audit_status,
        final_executable_output_expected_image_patch_byte_audit_hash: final_snapshot
            .final_executable_output_expected_image_patch_byte_audit_hash,
        final_executable_output_matches_verified_patched_image: final_snapshot
