use crate::{json_fields::*, reports::NsldMachOArm64PublicationAdmissionVerifyReport};

pub(crate) fn macho_arm64_publication_admission_verify_report_json(
    ...
    let fields = [
        ...
        json_string_field(
            "kind",
            "nsld_macho_arm64_publication_admission_verification",
        ),
        ...
        json_bool_field("private_image_matches", report.private_image_matches),
        json_bool_field(
            "signature_identity_matches",
            report.signature_identity_matches,
        ),
        json_bool_field("probe_evidence_valid", report.probe_evidence_valid),
        json_bool_field("valid", report.valid),
        json_string_field("current_shell_image_hash", &report.current_shell_image_hash),
        json_string_field(
        ...
        json_optional_string_field("probe_ledger_hash", report.probe_ledger_hash.as_deref()),
