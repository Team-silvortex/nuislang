...
pub(crate) fn nsld_final_executable_readiness_report(
    ...
    NsldFinalExecutableEmitReport {
        ...
        image_dry_run_resolver_status: None,
        image_dry_run_patch_application_status: None,
        image_dry_run_patch_byte_audit_status: None,
        image_dry_run_patch_byte_audit_hash: None,
        ...
        final_output_image_header_valid: Some(false),
        final_output_runnable_candidate: Some(false),
