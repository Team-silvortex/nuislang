...
pub(crate) fn nsld_final_executable_output_report(
    ...
    NsldFinalExecutableOutputReport {
        ...
        final_output_nsdb_runtime_dispatch_receipt_contract: None,
        final_output_nsdb_runtime_dispatch_receipt_status: "legacy-absent".to_owned(),
        final_output_nsdb_runtime_dispatch_receipt_hash: None,
        final_output_nsdb_runtime_dispatch_execution_identity_hash: None,
        final_output_nsdb_runtime_dispatch_import_identity_hash: None,
        final_output_nsdb_runtime_dispatch_table_identity: None,
        final_output_nsdb_runtime_dispatch_capability_mask: None,
        final_output_nsdb_runtime_dispatch_slot: None,
        final_output_nsdb_runtime_dispatch_status_code: None,
        final_output_nsdb_runtime_dispatch_acknowledged: None,
        ...
        final_output_nsdb_provider_completion_count: 0,
        final_output_nsdb_first_provider_family: None,
        final_output_nsdb_first_provider_output_contract: None,
        final_output_nsdb_first_provider_output_evidence: None,
        final_output_nsdb_provider_completion_claim_authority_contract: None,
        final_output_nsdb_provider_completion_claim_authority: None,
        final_output_nsdb_provider_completion_claim_authority_status: "not-applicable".to_owned(),
        final_output_nsdb_provider_completion_signature_contract: None,
        final_output_nsdb_provider_completion_signature_public_key_id: None,
        final_output_nsdb_provider_completion_signature_status: "not-applicable".to_owned(),
        final_output_nsdb_provider_completion_digest_contract: None,
        final_output_nsdb_provider_completion_set_hash_claim: None,
        final_output_nsdb_provider_completion_set_hash: None,
        final_output_nsdb_provider_completion_set_hash_validation_status: "not-applicable"
            .to_owned(),
        final_output_nsdb_provider_completions: Vec::new(),
        ...
        owned_package_summary_status: owned_package_summary_status.clone(),
        ...
        owned_package_summary_next_action: owned_package_summary_next_action.clone(),
        ...
        object_package_summary_status: owned_package_summary_status.clone(),
        object_package_summary_ready: nsdb_replay_ready,
        object_package_summary_replay_status: nsdb_replay_status.clone(),
        object_package_summary_replay_ready: nsdb_replay_ready,
        object_package_summary_next_action: owned_package_summary_next_action.clone(),
        object_package_summary_next_command: nsdb_replay_next_command.clone(),
