...
pub(crate) struct NsldObjectPlanReport {
    ...
    pub(crate) writer_backend_kind: String,
...
pub(crate) struct NsldObjectEmitVerifyReport {
    ...
    pub(crate) valid: bool,
    pub(crate) expected_object_plan_hash: String,
    pub(crate) expected_writer_backend_kind: String,
    pub(crate) expected_object_family: String,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) struct NsldObjectOutputVerifyReport {
    pub(crate) manifest: String,
    pub(crate) object_output_path: String,
    pub(crate) image_dry_run_path: String,
    pub(crate) valid: bool,
    pub(crate) expected_size_bytes: Option<usize>,
    pub(crate) actual_size_bytes: Option<usize>,
