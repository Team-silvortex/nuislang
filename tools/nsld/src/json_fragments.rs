    ...
    units
        ...
        .map(|unit| {
            let fields = [
                ...
                json_usize_field("hetero_node_count", unit.hetero_node_count),
                json_string_array_field("hetero_timestamps", &unit.hetero_timestamps),
                json_string_array_field("lifecycle_hooks", &unit.lifecycle_hooks),
                json_usize_field("wait_event_count", unit.wait_event_count),
                json_usize_field("emit_event_count", unit.emit_event_count),
