...
pub(crate) struct NsldContainerReport {
    ...
    pub(crate) loader_entry_abi_contract: String,
    pub(crate) loader_entry_machine_arch: String,
...
pub(crate) struct NsldContainerVerifyReport {
    ...
    pub(crate) expected_loader_entry_machine_arch: String,
    ...
    pub(crate) expected_shader_section_present: bool,
    pub(crate) expected_shader_section_id: String,
    pub(crate) expected_shader_loader_symbol_present: bool,
    pub(crate) expected_shader_loader_symbol_id: String,
    pub(crate) expected_shader_relocation_present: bool,
    pub(crate) expected_shader_relocation_id: String,
    pub(crate) expected_kernel_section_present: bool,
    pub(crate) expected_kernel_section_id: String,
    pub(crate) expected_kernel_loader_symbol_present: bool,
    pub(crate) expected_kernel_loader_symbol_id: String,
    pub(crate) expected_kernel_relocation_present: bool,
    pub(crate) expected_kernel_relocation_id: String,
    pub(crate) actual_container_layout_hash: Option<String>,
    ...
    pub(crate) actual_shader_section_present: bool,
    pub(crate) actual_shader_section_id: Option<String>,
    pub(crate) actual_shader_loader_symbol_present: bool,
    pub(crate) actual_shader_loader_symbol_id: Option<String>,
    pub(crate) actual_shader_relocation_present: bool,
    pub(crate) actual_shader_relocation_id: Option<String>,
    pub(crate) actual_kernel_section_present: bool,
    pub(crate) actual_kernel_section_id: Option<String>,
    pub(crate) actual_kernel_loader_symbol_present: bool,
    pub(crate) actual_kernel_loader_symbol_id: Option<String>,
    pub(crate) actual_kernel_relocation_present: bool,
    pub(crate) actual_kernel_relocation_id: Option<String>,
