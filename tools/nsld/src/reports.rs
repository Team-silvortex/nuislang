...
pub(crate) use super::reports_final_macho::*;
...
pub(crate) struct NsldArtifactChainReport {
    ...
    pub(crate) final_output_boundary_ready: bool,
    pub(crate) final_output_boundary_command_id: Option<String>,
    pub(crate) final_output_boundary_command: Option<String>,
    pub(crate) final_output_boundary_command_resolved: Option<String>,
    pub(crate) final_output_boundary_reason: Option<String>,
    pub(crate) final_output_boundary_blockers: Vec<String>,
...
pub(crate) struct NsldLinkUnitReport {
    ...
    pub(crate) link_input_count: usize,
    pub(crate) hetero_node_count: usize,
    pub(crate) clock_edge_count: usize,
    pub(crate) data_segment_count: usize,
...
pub(crate) struct NsldLinkUnitDiagnostic {
    ...
    pub(crate) hetero_node_count: usize,
    pub(crate) hetero_timestamps: Vec<String>,
    pub(crate) lifecycle_hooks: Vec<String>,
    pub(crate) wait_event_count: usize,
    pub(crate) emit_event_count: usize,
    pub(crate) clock_edge_count: usize,
    pub(crate) data_segment_count: usize,
...
pub(crate) struct NsldLinkUnitsVerifyReport {
    ...
    pub(crate) expected_hetero_node_count: usize,
    ...
    pub(crate) actual_hetero_node_count: Option<usize>,
