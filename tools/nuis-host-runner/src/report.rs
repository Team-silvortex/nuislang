...
use crate::report_native_entry::{native_entry_evidence_json, print_native_entry_evidence};
...
pub(super) fn print_text_report(report: &RunnerReport) {
    ...
    println!(
        "  runtime_bootstrap_execution: contract={} status={} identity={}",
        report.runtime_bootstrap_execution_contract,
        report.runtime_bootstrap_execution_status,
        report.runtime_bootstrap_execution_identity_hash
    );
    println!(
        "  runtime_bootstrap_activated_service_count: {}",
        report.runtime_bootstrap_activated_service_count
    );
    println!(
        "  runtime_bootstrap_blockers: {}",
        joined_or_none(&report.runtime_bootstrap_blockers)
    );
    print_native_entry_evidence(&report.native_entry_handoff);
    ...
    println!(
        ...
        report.container_loader_metadata_binding_parsed_count
    );
    println!(
    ...
    println!(
        "  container_loader_clock_root: contract={} count={} hash={} status={}",
        report
            .container_loader_clock_root_contract
            .as_deref()
            .unwrap_or("<none>"),
        optional_usize_text(report.container_loader_clock_root_count),
        report
            .container_loader_clock_root_hash
            .as_deref()
            .unwrap_or("<none>"),
        report
            .container_loader_clock_root_status
            .as_deref()
            .unwrap_or("<none>")
    );
    println!(
        "  container_loader_glm_root: contract={} count={} hash={} status={}",
        report
            .container_loader_glm_root_contract
            .as_deref()
            .unwrap_or("<none>"),
        optional_usize_text(report.container_loader_glm_root_count),
        report
            .container_loader_glm_root_hash
            .as_deref()
            .unwrap_or("<none>"),
        report
            .container_loader_glm_root_status
            .as_deref()
            .unwrap_or("<none>")
    );
    println!(
    ...
    println!(
        ...
        optional_usize_text(report.container_loader_provider_dispatch_count)
    );
    println!(
        "  container_loader_provider_dispatch_parsed_count: {}",
        report.container_loader_provider_dispatch_parsed_count
    );
    println!(
    ...
    println!(
        "  container_loader_provider_dispatch_selected_set_hash: {}",
        report
            .container_loader_provider_dispatch_selected_set_hash
            .as_deref()
            .unwrap_or("<none>")
    ...
    println!(
        "  container_loader_provider_dispatches: {}",
        provider_dispatch_text(report)
    );
    println!(
        "  nsb_layout_hash: {}",
...
pub(super) fn render_json_report(report: &RunnerReport) -> String {
    format!(
        "{{\"kind\":\"nuis_host_runner\",\"protocol\":\"{}\",\"ready\":{},\"would_enter_lifecycle_hook\":{},\"runtime_bootstrap_contract\":\"{}\",\"runtime_bootstrap_identity_contract\":\"{}\",\"runtime_bootstrap_identity_hash\":\"{}\",\"runtime_bootstrap_status\":\"{}\",\"runtime_bootstrap_stage_count\":{},\"runtime_bootstrap_mapped_section_count\":{},\"runtime_bootstrap_applied_relocation_count\":{},\"runtime_bootstrap_execution_contract\":\"{}\",\"runtime_bootstrap_execution_identity_hash\":\"{}\",\"runtime_bootstrap_execution_status\":\"{}\",\"runtime_bootstrap_activated_service_count\":{},\"runtime_bootstrap_blockers\":[{}],\"native_entry_handoff\":{},\"manifest_path\":\"{}\",\"nsb_path\":{},\"nsb_readable\":{},\"nsb_hash_expected\":{},\"nsb_hash_actual\":{},\"nsb_hash_matches\":{},\"nsb_payload_offset\":{},\"nsb_payload_span\":{},\"nsb_payload_region_mapped\":{},\"nsb_payload_region_bytes\":{},\"nsb_payload_region_hash\":{},\"nsb_payload_scan_status\":\"{}\",\"nsb_payload_scan_kind\":\"{}\",\"nsb_payload_prefix_hex\":{},\"nsb_payload_prefix_text\":{},\"container_loader_status\":\"{}\",\"container_schema\":{},\"container_schema_version\":{},\"container_kind\":{},\"container_producer\":{},\"container_producer_phase\":{},\"container_ready\":{},\"container_blockers\":[{}],\"container_magic\":{},\"container_version\":{},\"container_metadata_table_hash\":{},\"container_section_table_hash\":{},\"container_hash\":{},\"container_section_count\":{},\"container_section_parsed_count\":{},\"container_first_section_id\":{},\"container_first_section_kind\":{},\"container_entry_section_found\":{},\"container_payload_size_bytes\":{},\"container_payload_hash\":{},\"container_payload_path\":{},\"container_loader_readiness\":{},\"container_loader_blockers\":[{}],\"container_loader_entry_kind\":{},\"container_loader_entry_symbol\":{},\"container_loader_entry_section_id\":{},\"container_loader_symbol_count\":{},\"loader_symbol_table_hash\":{},\"container_loader_symbol_status\":\"{}\",\"container_loader_symbol_id\":{},\"container_loader_symbol_kind\":{},\"container_loader_symbol_name\":{},\"container_loader_symbol_lifecycle_hook\":{},\"container_loader_symbol_section_id\":{},\"container_relocation_count\":{},\"relocation_table_hash\":{},\"container_relocation_parsed_count\":{},\"container_first_relocation_kind\":{},\"container_first_relocation_source_section_id\":{},\"container_first_relocation_target_symbol_id\":{},\"container_first_relocation_targets_loader_symbol\":{},\"container_first_relocation_source_matches_loader_symbol\":{},\"compatibility_domain_count\":{},\"compatibility_domain_table_hash\":{},\"compatibility_domain_parsed_count\":{},\"compatibility_domain_first_kind\":{},\"compatibility_domain_required_count\":{},\"external_import_count\":{},\"external_import_table_hash\":{},\"external_import_parsed_count\":{},\"external_import_first_kind\":{},\"external_import_first_name\":{},\"external_import_required_imports\":[{}],\"backend_artifact_payload_count\":{},\"backend_artifact_payload_table_hash\":{},\"backend_artifact_payload_parsed_count\":{},\"backend_artifact_payload_ready_count\":{},\"backend_artifact_payload_first_id\":{},\"backend_artifact_payload_first_kind\":{},\"backend_artifact_payload_first_role_status\":{},\"container_loader_handoff_status\":\"{}\",\"container_loader_handoff_ready\":{},\"container_loader_handoff_blockers\":[{}],\"container_loader_metadata_binding_count\":{},\"container_loader_metadata_binding_parsed_count\":{},\"container_loader_metadata_binding_table_hash\":{},\"container_loader_metadata_binding_validation_status\":\"{}\",\"container_loader_clock_root_contract\":{},\"container_loader_clock_root_count\":{},\"container_loader_clock_root_hash\":{},\"container_loader_clock_root_status\":{},\"container_loader_glm_root_contract\":{},\"container_loader_glm_root_count\":{},\"container_loader_glm_root_hash\":{},\"container_loader_glm_root_status\":{},\"container_loader_selected_provider_bundle_set_contract\":{},\"container_loader_selected_provider_bundle_count\":{},\"container_loader_selected_provider_bundle_set_hash\":{},\"container_loader_provider_dispatch_status\":\"{}\",\"container_loader_provider_dispatch_count\":{},\"container_loader_provider_dispatch_parsed_count\":{},\"container_loader_provider_dispatch_table_hash\":{},\"container_loader_provider_dispatch_selected_set_hash\":{},\"container_loader_provider_dispatches\":[{}],\"nsb_layout_hash\":{},\"nsb_byte_map_hash\":{},\"scheduler_entry\":\"{}\",\"lifecycle_hook\":\"{}\",\"launch_steps\":[{}],\"blockers\":[{}]}}",
        json_escape(RUNNER_PROTOCOL),
        report.ready,
        report.would_enter_lifecycle_hook,
        json_escape(&report.runtime_bootstrap_contract),
        json_escape(&report.runtime_bootstrap_identity_contract),
        json_escape(&report.runtime_bootstrap_identity_hash),
        json_escape(&report.runtime_bootstrap_status),
        report.runtime_bootstrap_stage_count,
        report.runtime_bootstrap_mapped_section_count,
        report.runtime_bootstrap_applied_relocation_count,
        json_escape(&report.runtime_bootstrap_execution_contract),
        json_escape(&report.runtime_bootstrap_execution_identity_hash),
        json_escape(&report.runtime_bootstrap_execution_status),
        report.runtime_bootstrap_activated_service_count,
        json_string_array(&report.runtime_bootstrap_blockers),
        native_entry_evidence_json(&report.native_entry_handoff),
        ...
        json_optional_usize(report.container_loader_metadata_binding_count),
        report.container_loader_metadata_binding_parsed_count,
        ...
        json_escape(&report.container_loader_metadata_binding_validation_status),
        json_optional_string(report.container_loader_clock_root_contract.as_deref()),
        json_optional_usize(report.container_loader_clock_root_count),
        json_optional_string(report.container_loader_clock_root_hash.as_deref()),
        json_optional_string(report.container_loader_clock_root_status.as_deref()),
        json_optional_string(report.container_loader_glm_root_contract.as_deref()),
        json_optional_usize(report.container_loader_glm_root_count),
        json_optional_string(report.container_loader_glm_root_hash.as_deref()),
        json_optional_string(report.container_loader_glm_root_status.as_deref()),
        json_optional_string(
            report
                .container_loader_selected_provider_bundle_set_contract
                .as_deref()
        ),
        json_optional_usize(report.container_loader_selected_provider_bundle_count),
        json_optional_string(
            report
                .container_loader_selected_provider_bundle_set_hash
                .as_deref()
        ),
        json_escape(&report.container_loader_provider_dispatch_status),
        json_optional_usize(report.container_loader_provider_dispatch_count),
        report.container_loader_provider_dispatch_parsed_count,
        json_optional_string(
            report
                .container_loader_provider_dispatch_table_hash
        ...
        json_provider_dispatches(report),
...
fn provider_dispatch_text(report: &RunnerReport) -> String {
    if report.container_loader_provider_dispatches.is_empty() {
...
fn json_provider_dispatches(report: &RunnerReport) -> String {
    report
        .container_loader_provider_dispatches
        .iter()
        .map(|entry| {
            format!(
                "{{\"dispatch_id\":\"{}\",\"package_id\":\"{}\",\"bundle_id\":\"{}\",\"provider_family\":\"{}\",\"runner_contract\":\"{}\",\"runner_adapter_contract\":\"{}\",\"runner_adapter_id\":\"{}\"}}",
                json_escape(&entry.dispatch_id),
                json_escape(&entry.package_id),
                json_escape(&entry.bundle_id),
                json_escape(&entry.provider_family),
                json_escape(&entry.runner_contract),
                json_escape(&entry.runner_adapter_contract),
                json_escape(&entry.runner_adapter_id)
            )
        })
        .collect::<Vec<_>>()
        .join(",")
