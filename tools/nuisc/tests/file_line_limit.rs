...
fn exception_budgets() -> BTreeMap<&'static str, usize> {
    BTreeMap::from([
        ...
        ("tools/nsld/src/final_executable_emit.rs", 674),
        ...
        ("tools/nsld/src/object_image_dry_run.rs", 1071),
        ("tools/nsld/src/object_writer_input.rs", 682),
        ("tools/nsld/src/reports.rs", 1109),
        ("tools/nuis/src/cli.rs", 1202),
        ("tools/nuis/src/galaxy.rs", 2035),
        ("tools/nuis/src/main.rs", 9967),
        ("tools/nuis/src/surface_render.rs", 1700),
        ("tools/nuisc/src/aot_domain_index_verify.rs", 726),
        ("tools/nuisc/src/aot_tests.rs", 4444),
        ("tools/nuisc/src/frontend/match_lowering.rs", 605),
        ("tools/nuisc/src/frontend/tests_control_flow.rs", 1682),
        ("tools/nuisc/src/frontend/tests_enums.rs", 1604),
        ("tools/nuisc/src/frontend/tests_frontend_core.rs", 3231),
        ("tools/nuisc/src/frontend/tests_frontend_semantics.rs", 4671),
        (
        ...
        ("tools/nuisc/src/frontend/tests_generics.rs", 5332),
        ("tools/nuisc/src/frontend/tests_higher_order.rs", 5626),
        ...
        ("tools/nuisc/src/linker.rs", 974),
        ("tools/nuisc/src/lowering/core_exprs.rs", 646),
        (
            "tools/nuisc/src/lowering/tests_async_network_runtime.rs",
            657,
        ),
        ("tools/nuisc/src/lowering/tests_async_runtime.rs", 3259),
        ("tools/nuisc/src/lowering/tests_branch_helpers.rs", 5456),
        ...
        ("tools/nuisc/src/project/tests/multidomain_async.rs", 4022),
        (
        ...
        ("tools/nuisc/tests/task_compile.rs", 2827),
        ("tools/yir-pack-aot/src/main.rs", 4405),
    ])
}
