...
pub struct NuisCompiledArtifactVerifyReport {
    ...
    pub host_object_ids: Vec<String>,
    pub host_object_roles: Vec<String>,
    pub host_object_formats: Vec<String>,
    pub host_object_bytes: Vec<usize>,
    pub host_object_hashes: Vec<String>,
