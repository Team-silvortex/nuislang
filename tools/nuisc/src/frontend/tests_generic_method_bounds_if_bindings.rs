...
#[test]
fn accepts_match_bind_pattern_value_used_inside_if_when_bound_is_present() {
...
#[test]
fn reports_match_bind_pattern_value_used_inside_if_for_missing_generic_method_bound() {
...
#[test]
fn reports_match_bind_pattern_value_used_inside_if_for_ambiguous_wrong_bound_method_call() {
    let error = parse_nuis_module(
        r#"
        mod cpu Main {
          trait Addable {
