...
use self::data_builtins::lower_data_builtin_call;
use self::generic_rewrite::rewrite_generic_calls_in_function;
use self::higher_order::expand_higher_order_functions;
use self::kernel_builtins::lower_kernel_builtin_call;
use self::match_lowering::lower_match_stmt_with_async;
use self::metadata::{
    helper_visible_struct_annotations, hidden_private_field_count, lower_ast_attributes,
    ModuleConstValue,
};
use self::network_builtins::lower_network_builtin_call;
use self::nova_builtins::lower_nova_builtin_call;
use self::return_inference::infer_missing_function_return_type;
use self::shader_builtins::lower_shader_builtin_call;
use self::task_builtins::lower_task_builtin_call;
use aliases::*;
use nuis_semantics::model::{
    ...
    NirFunction, NirGenericParam, NirImplDef, NirImplMethod, NirModule, NirResultFamily, NirStmt,
