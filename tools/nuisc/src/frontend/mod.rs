...
use nuis_semantics::model::{
    ...
    NirFunction, NirGenericParam, NirImplDef, NirImplMethod, NirKernelAxis, NirKernelMapOp,
    NirKernelZipOp, NirModule, NirResultFamily, NirResultStage, NirStmt, NirStructDef,
