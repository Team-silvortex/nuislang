...
use self::generics::{infer_generic_substitutions, specialize_function_template};
...
use nuis_semantics::model::{
    ...
    NirAttributeValue, NirBinaryOp, NirConstItem, NirExpr, NirExprEffectClass, NirExternFunction,
    NirExternInterface, NirFunction, NirGenericParam, NirImplDef, NirImplMethod, NirKernelAxis,
    NirKernelMapOp, NirKernelZipOp, NirModule, NirParam, NirResultFamily, NirResultStage, NirStmt,
