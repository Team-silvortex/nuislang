...
use nuis_semantics::model::{AstExpr, AstTypeRef};
...
use super::exprs_alias_expected::seed_alias_generic_substitutions_from_expected_pattern;
use super::exprs_alias_inputs::{
    AliasAwarePatternTypeInput, AliasInferenceContext, AliasUsageInferenceInput,
};
use super::exprs_aliases::{resolved_struct_constructor_alias, resolved_struct_literal_alias};
use super::exprs_aliases::{StructConstructorAliasInput, StructLiteralAliasInput};

pub(super) fn infer_alias_struct_constructor_type_from_args(
    alias_name: &str,
    args: &[AstExpr],
...
pub(super) fn infer_alias_struct_literal_type_from_fields(
    alias_name: &str,
