use super::test_support::{resolved_galaxy_dependency_fixture, write_temp_project_fixture};
use super::*;
use std::fs;
...
"#,
    ...
    assert_eq!(
        ...
        vec![
            ...
            "lib/compiler_payload.ns".to_owned(),
            "lib/compiler_payload_registry.ns".to_owned(),
...
"#,
    ...
    assert!(imports_index.contains(
        "library\tstd\tlib/compiler_payload_registry.ns\timport_policy=project-auto\tauto_injectable=true\tvisible=true"
    ));
    assert!(imports_index.contains(
    ...
    assert!(imports_index.contains("visible\tcpu\tStdCompilerPayload\tdoc_items="));
    assert!(imports_index.contains("visible\tcpu\tStdCompilerPayloadRegistry\tdoc_items="));
...
"#,
        ...
        resolved_galaxies: vec![resolved_galaxy_dependency_fixture(
            "manual",
            "workspace",
            "nuis.manual",
            "surface.manual.contracts.v1",
            "lib/manual_contracts.ns",
