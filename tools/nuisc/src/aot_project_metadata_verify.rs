...
pub(crate) struct ProjectMetadataArtifactsVerifyInput<'a> {
    pub manifest_path: &'a Path,
    pub input: &'a str,
    pub output_dir: &'a str,
    pub doc_index_path: Option<&'a str>,
    pub doc_index_module_count: usize,
    pub doc_index_documented_item_count: usize,
    pub project_plan_index: Option<&'a str>,
    pub project_plan_summary: Option<&'a str>,
    pub project_docs_index: Option<&'a str>,
    ...
    pub project_imports_index: Option<&'a str>,
    ...
    pub project_packet_index: Option<&'a str>,
    pub project_host_ffi_index: Option<&'a str>,
}

pub(crate) fn verify_project_metadata_artifacts(
    input: ProjectMetadataArtifactsVerifyInput<'_>,
) -> Result<ProjectMetadataVerifyReport, String> {
    let ProjectMetadataArtifactsVerifyInput {
        manifest_path,
        input,
        output_dir,
        doc_index_path,
