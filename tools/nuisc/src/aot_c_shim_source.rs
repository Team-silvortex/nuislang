...
use crate::aot_c_shim_owned_buffer_runtime::append_c_shim_owned_buffer_runtime;
use crate::aot_c_shim_owned_object_runtime::append_c_shim_owned_object_runtime;
...
pub(crate) fn render_c_shim_source(ast: &AstModule) -> String {
    ...
    append_c_shim_owned_buffer_runtime(&mut out);
    append_c_shim_owned_object_runtime(&mut out);
