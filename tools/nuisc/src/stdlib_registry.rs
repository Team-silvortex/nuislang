    ...
    fn std_manifest_exposes_canonical_surface_registry_ids() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                "surface.std.compiler-data-model.v3".to_owned(),
                "surface.std.compiler-data-model.v4".to_owned(),
                "surface.std.compiler-data-model.v5".to_owned(),
                "surface.std.compiler-data-model.v6".to_owned(),
                "surface.std.compiler-data-model.v7".to_owned(),
