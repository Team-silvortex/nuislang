...
pub(crate) fn verify_artifact_json(
    ...
    let fields = vec![
        ...
        json_usize_field("host_object_count", report.host_object_count),
        json_string_array_field("host_object_ids", &report.host_object_ids),
        json_string_array_field("host_object_roles", &report.host_object_roles),
        json_string_array_field("host_object_formats", &report.host_object_formats),
        json_usize_array_field("host_object_bytes", &report.host_object_bytes),
        json_string_array_field("host_object_hashes", &report.host_object_hashes),
