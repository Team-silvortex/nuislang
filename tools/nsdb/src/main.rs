...
use crate::{
    ...
    provider_sample_json::{
        json_escape, provider_sample_execute_json, provider_sample_materialize_json,
    },
    ...
    match parse_args(env::args().skip(1))? {
        ...
        Command::MaterializeProviderSamples {
            ...
            if json {
                ...
                println!(
                    ...
                    report.provider_bundle_manifest_hash
                );
                println!(
                ...
                println!(
                    "device_provider_sample_first_provider_bundle_package_id: {}",
                    report.first_provider_bundle_package_id
                );
                println!(
                    "device_provider_sample_first_provider_bundle_id: {}",
        ...
        Command::ExecuteProviderSamples {
            ...
            if json {
                ...
                println!(
                    "device_provider_sample_execute_provider_bundle_registry_contract: {}",
                    report.provider_bundle_registry_contract
                );
                println!(
                    "device_provider_sample_execute_provider_bundle_manifest_contract: {}",
                    report.provider_bundle_manifest_contract
                );
                println!(
                    "device_provider_sample_execute_provider_bundle_manifest_hash: {}",
                    report.provider_bundle_manifest_hash
                );
                println!(
                    "device_provider_sample_execute_provider_bundle_manifest_entry_count: {}",
                    report.provider_bundle_manifest_entry_count
                );
                println!(
                    "device_provider_sample_execute_first_provider_bundle_package_id: {}",
                    report.first_provider_bundle_package_id
                );
                println!(
