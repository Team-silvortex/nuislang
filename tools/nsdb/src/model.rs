...
pub struct PayloadExecutionProviderCompletion {
    ...
    pub output_contract: String,
    pub output_evidence: String,
    pub completion_evidence_contract: String,
    pub completion_evidence_status: String,
    pub completion_evidence_count: usize,
    pub completion_clock_evidence: String,
    pub completion_tokens: String,
    pub glm_release_contract: String,
    pub glm_release_tokens: String,
    pub glm_release_status: String,
    pub code_asset_identity_contract: String,
    pub code_asset_identity_status: String,
    pub code_asset_identity_asset_id: String,
    pub code_asset_identity_hash: String,
    pub code_asset_identity_set_contract: String,
...
pub(crate) struct NsdbDeviceProviderSampleRecordInfo {
    ...
    pub(crate) provider_output_payload_contract: String,
    pub(crate) provider_output_payload_status: String,
    pub(crate) provider_output_payload_evidence_status: String,
    pub(crate) provider_output_payload_evidence: String,
    pub(crate) provider_output_payload_detail: String,
    pub(crate) provider_output_payload_next_action: String,
...
pub(crate) struct NsdbPayloadExecutionHandoffInfo {
    ...
    pub(crate) provider_completion_signature_contract: String,
    pub(crate) provider_completion_signature_public_key_id: String,
    pub(crate) provider_completion_signature: String,
    pub(crate) provider_completion_signature_status: String,
...
pub(crate) struct NsdbPayloadExecutionEvent {
    ...
    pub(crate) output_evidence: String,
    pub(crate) provider_completion_evidence:
        crate::provider_completion_evidence::ProviderCompletionEvidence,
