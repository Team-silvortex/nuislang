...
pub(crate) fn pixelmagic_native_output_summary(
    ...
    Some(PixelMagicNativeOutputSummary {
        ...
        completion_evidence_contract: "none".to_owned(),
        completion_clock_evidence: "none".to_owned(),
        completion_token: "none".to_owned(),
        completion_status: "not-applicable".to_owned(),
        glm_release_contract: "none".to_owned(),
        glm_release_token: "none".to_owned(),
...
pub(crate) fn metal_native_output_summary(
    ...
    PixelMagicNativeOutputSummary {
        ...
        completion_evidence_contract: "pending".to_owned(),
        completion_clock_evidence: "pending".to_owned(),
        completion_token: "pending".to_owned(),
        completion_status: "pending".to_owned(),
        glm_release_contract: "pending".to_owned(),
        glm_release_token: "pending".to_owned(),
        glm_release_status: "pending".to_owned(),
