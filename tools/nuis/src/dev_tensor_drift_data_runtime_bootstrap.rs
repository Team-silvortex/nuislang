...
pub(crate) const DEV_TENSOR_RUNTIME_BOOTSTRAP_DRIFT_CHECKS: &[DevTensorDriftCheckSpec] = &[
    ...
    DevTensorDriftCheckSpec {
        ...
        required_patterns: &[
            ...
            "pub keys: CompilerVector",
            "pub values: CompilerVector",
            "pub struct CompilerArena",
            "pub kinds: CompilerVector",
            "pub field2s: CompilerVector",
            "pub struct CompilerDiagnostic",
            "pub fn compiler_vector_full",
            "pub fn compiler_vector_shape_valid",
            "pub fn compiler_text_push_scalar",
            "pub fn compiler_map_shape_valid",
            "pub fn compiler_map_find_index",
            "pub fn compiler_map_identity",
            "pub fn compiler_arena_shape_valid",
            "pub fn compiler_arena_store",
            "pub fn compiler_arena_object_value",
            "pub fn compiler_arena_identity",
        ],
    },
    DevTensorDriftCheckSpec {
    ...
    DevTensorDriftCheckSpec {
        ...
        required_patterns: &[
            ...
            "nuis-compiler-structural-page-v1",
    ...
    DevTensorDriftCheckSpec {
        ...
        required_patterns: &[
            ...
            "compiler_projection_ast_page_identity_raw",
            "compiler_projection_nir_page_identity_raw",
        ],
    },
    DevTensorDriftCheckSpec {
        id: "nuis-compiler-structural-page-artifact",
        path: "crates/nuis-artifact/src/compiler_structural_projection_page.rs",
        required_patterns: &[
            "nuis-compiler-structural-page-v1",
            "CompilerProjectionPageIdentity",
            "compiler_projection_first_page_identity",
            "continuation_body_hash",
