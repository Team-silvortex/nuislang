...
pub(crate) const DEV_TENSOR_RUNTIME_BOOTSTRAP_DRIFT_CHECKS: &[DevTensorDriftCheckSpec] = &[
    ...
    DevTensorDriftCheckSpec {
        ...
        path: "docs/reference/nuis-bootstrap-language-subset-v4.toml",
        required_patterns: &[
    ...
    DevTensorDriftCheckSpec {
        ...
        path: "docs/reference/nuis-compiler-candidate-production-v3.toml",
        required_patterns: &[
            "nuis-compiler-candidate-production-v3",
            "nuis-stage1-materialized-token-page-producer-v3",
            "stage1-candidate-component-production-no-replacement",
            "nuis bootstrap-candidate-build",
            "host-byte-transport-packing-and-state-orchestration-without-token-semantics",
            "reference_page_identity = 164749511446",
    ...
    DevTensorDriftCheckSpec {
        ...
        required_patterns: &[
            "stage-neutral boundary to `usable/88`",
            "cache-bypassed clean builds keep both driver and\nreproducibility gate at `usable/89`",
            "Data model v3 is `usable/90`",
            "canonical 91-byte token page with identity `164749511446`",
