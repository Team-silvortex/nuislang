...
pub(crate) const DEV_TENSOR_RUNTIME_DEV_LINEAGE_DRIFT_CHECKS: &[DevTensorDriftCheckSpec] = &[
    ...
    DevTensorDriftCheckSpec {
        id: "beta-0.14-mainline-router",
        path: "docs/current-mainline-map.md",
        required_patterns: &[
            "current `beta-0.14.*` priority",
            "nuis-beta-0.14.0-snapshot.md",
            "nuis-beta-0.14.0-release-checklist.md",
    ...
    DevTensorDriftCheckSpec {
        id: "beta-0.14-repository-frontdoor",
        path: "README.md",
        required_patterns: &[
            "repository is on `beta-0.14.*`",
