...
pub(super) const CHECKS: &[DevTensorDriftCheckSpec] = &[
    ...
    DevTensorDriftCheckSpec {
        ...
        required_patterns: &[
            "generated.contains(&f.name) && !scoped.contains(&f.name)",
    ...
    DevTensorDriftCheckSpec {
        ...
        path: "tools/nuisc/src/lowering/buffer_loop_outline.rs",
        required_patterns: &[
            "capture_projection::project(module, &capture_functions, &value_layouts)",
    ...
    DevTensorDriftCheckSpec {
        ...
        required_patterns: &[
            ...
            "!in_loop && self.writes.get(name) == Some(&1)",
    ...
    DevTensorDriftCheckSpec {
        ...
        required_patterns: &[
            ...
            "iteration_local_aliases_stay_whole_but_invariant_outer_alias_reads_project",
            "repeated_branch_alias_names_keep_exact_subrecords",
