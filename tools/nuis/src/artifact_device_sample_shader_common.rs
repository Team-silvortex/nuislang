...
pub(crate) fn render_u32_pair_artifact_binding(
    ...
    format!(
        "{prefix}input_binding_contract=nuis-provider-input-binding-v1;{prefix}input_binding_count=2;{prefix}input_binding_0_name=input.values;{prefix}input_binding_0_source=artifact;{prefix}input_binding_0_element_type=u32;{prefix}input_binding_0_shape={U32_ELEMENT_COUNT};{prefix}input_binding_0_byte_length={};{prefix}input_binding_0_content_hash={};{prefix}input_binding_0_payload_path={left_file_name};{prefix}input_binding_0_producer_request_id=none;{prefix}input_binding_0_producer_output_buffer=none;{prefix}input_binding_1_name=input.right;{prefix}input_binding_1_source=artifact;{prefix}input_binding_1_element_type=u32;{prefix}input_binding_1_shape={U32_ELEMENT_COUNT};{prefix}input_binding_1_byte_length={};{prefix}input_binding_1_content_hash={};{prefix}input_binding_1_payload_path={right_file_name};{prefix}input_binding_1_producer_request_id=none;{prefix}input_binding_1_producer_output_buffer=none",
        left.len(),
        fnv1a64_hex(left),
        right.len(),
        fnv1a64_hex(right),
