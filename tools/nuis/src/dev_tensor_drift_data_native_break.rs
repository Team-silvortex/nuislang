...
pub(super) const CHECKS: &[DevTensorDriftCheckSpec] = &[
    ...
    DevTensorDriftCheckSpec {
        ...
        required_patterns: &[
            ...
            "then_body.len() <= 1",
            "else_body.len() <= 1",
            "name.is_some_and(|name| name != binding.as_str())",
    ...
    DevTensorDriftCheckSpec {
        id: "native-session-nested-scoped-iteration",
        path: "tools/nuisc/src/lowering/buffer_loop_outline/control_loops/nested.rs",
        required_patterns: &[
            "__nuis_scalar_iteration",
            "branches::outline_effects",
            "scalar_carries::projected_call",
            "conditions::outline",
        ],
    },
    DevTensorDriftCheckSpec {
        id: "native-session-nested-short-circuit",
        path: "tools/nuisc/src/lowering/buffer_loop_outline/control_loops/nested_conditions.rs",
        required_patterns: &[
            "__nuis_scalar_predicate",
            "__nuis_predicate_gate",
            "NirExpr::Bool(false)",
            "negate(call)",
        ],
    },
    DevTensorDriftCheckSpec {
        id: "native-session-nested-source-regression",
        path: "tools/nuisc/src/lowering/buffer_loop_outline/control_loops/nested_tests.rs",
        required_patterns: &[
            "nested_decisions_with_distinct_leaves_use_scoped_helpers_not_two_value_collapse",
            "nested_arms_check_every_path_for_order_type_effect_and_header_safety",
            "nested_normalization_has_a_depth_guard_without_weakening_native_limits",
        ],
    },
    DevTensorDriftCheckSpec {
        id: "native-session-nested-execution",
        path: "tools/nuisc/tests/native_application_bridge/aggregate_nested.rs",
        required_patterns: &[
            "nested_carries_match_native_reference_and_ordered_wrapping_oracle",
            "nested_compound_guards_match_actual_short_circuit_comparison_counts",
            "nested_carry_preflight_and_arithmetic_traps_preserve_skipped_path",
        ],
    },
    DevTensorDriftCheckSpec {
        id: "native-session-nested-frontdoor",
        path: "tools/nuis/tests/native_session_workflow.rs",
        required_patterns: &[
            "aggregate_nested_loops.ns",
            "native_guarded_nested_aggregate_build_cache_and_standalone_relocation",
