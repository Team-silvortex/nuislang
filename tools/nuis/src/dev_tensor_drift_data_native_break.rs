...
pub(super) const CHECKS: &[DevTensorDriftCheckSpec] = &[
    ...
    DevTensorDriftCheckSpec {
        ...
        required_patterns: &[
            ...
            "name.is_some_and(|name| name != branch_name)",
    ...
    DevTensorDriftCheckSpec {
        id: "native-session-nested-carry-source-policy",
        path: "tools/nuisc/src/lowering/buffer_loop_outline/control_loops/nested_tests.rs",
        required_patterns: &[
            "nested_update_trees_reuse_shared_collapse_and_transitive_catalog",
            "nested_conditions_cannot_hide_stale_forward_or_fallible_inputs",
            "nested_arms_keep_shape_types_and_multi_outcome_boundaries_fail_closed",
            "nested_source_catalog_does_not_copy_native_tree_budgets",
        ],
    },
    DevTensorDriftCheckSpec {
        id: "native-session-nested-carry-shared-collapse",
        path: "tools/nuisc/src/lowering/loop_preparation_carry_tree.rs",
        required_patterns: &[
    ...
    DevTensorDriftCheckSpec {
        id: "native-session-nested-carry-registration",
        path: "tools/nuisc/tests/native_application_bridge.rs",
        required_patterns: &["mod aggregate_nested;", "mod aggregate_nested_tree;"],
    },
    DevTensorDriftCheckSpec {
        id: "native-session-nested-carry-execution",
        ...
        required_patterns: &[
            ...
            "nested_updates_preserve_variable_widths_and_dependent_carry_values",
            "nested_updates_retain_preflight_selected_traps_and_exact_trip_limit",
            "nested_tree_admission_retains_backend_owned_condition_budgets",
            "assert_eq!(count, 32)",
            "nested_aggregate_updates_compose_with_typed_lifecycle",
            "nested_aggregate_reference_fuel_failure_retains_state_and_cleanup",
        ],
    },
    DevTensorDriftCheckSpec {
        id: "native-session-nested-carry-original-tree-oracle",
        ...
        required_patterns: &[
            ...
            "fn chain(depth: usize)",
        ],
    },
    DevTensorDriftCheckSpec {
        id: "native-session-nested-carry-frontdoor",
        path: "tools/nuis/tests/native_session_workflow.rs",
        required_patterns: &[
