...
pub(super) const CHECKS: &[DevTensorDriftCheckSpec] = &[
    ...
    DevTensorDriftCheckSpec {
        ...
        required_patterns: &[
            ...
            "one_sided_carry_updates_inside_flat_branches_still_fail_closed",
    ...
    DevTensorDriftCheckSpec {
        ...
        required_patterns: &[
            "node.op.args.len() > 5 + 5 * MAX_SCALAR_SLOTS",
            "yir_domain_cpu::parse_conditional_carries(",
            "does not admit compound carry conditions",
