...
pub(crate) const DEV_TENSOR_RUNTIME_BOOTSTRAP_REPRODUCIBILITY_DRIFT_CHECKS:
    ...
    DevTensorDriftCheckSpec {
        ...
        required_patterns: &[
            ...
            "ast_page_identity",
            "AST structural page chain mismatch",
            "nir_page_identity",
            "NIR structural page chain mismatch",
        ],
    },
    DevTensorDriftCheckSpec {
        id: "nuis-compiler-candidate-production-contract",
        path: "docs/reference/nuis-compiler-candidate-production-v6.toml",
        required_patterns: &[
            "nuis-compiler-candidate-production-v6",
    ...
    DevTensorDriftCheckSpec {
        ...
        required_patterns: &[
            ...
            "`usable/92`",
            "both driver and\nreproducibility gate to `usable/93`",
            "Data model v3 is `usable/93`",
            "second-page identities `149528711957` and `146705724977`",
