...
pub(crate) const DEV_TENSOR_RUNTIME_BOOTSTRAP_REPRODUCIBILITY_DRIFT_CHECKS:
    ...
    DevTensorDriftCheckSpec {
        ...
        path: "docs/reference/nuis-compiler-candidate-production-v4.toml",
        required_patterns: &[
            "nuis-compiler-candidate-production-v4",
            ...
            "host-byte-transport-packing-and-state-orchestration-without-token-or-ast-semantics",
    ...
    DevTensorDriftCheckSpec {
        ...
        required_patterns: &[
            ...
            "`usable/90`",
            "both driver and\nreproducibility gate at `usable/91`",
            "Data model v3 is",
            "AST continuation identity `174028320749`",
