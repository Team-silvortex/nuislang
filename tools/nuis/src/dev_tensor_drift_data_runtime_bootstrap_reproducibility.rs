...
pub(crate) const DEV_TENSOR_RUNTIME_BOOTSTRAP_REPRODUCIBILITY_DRIFT_CHECKS:
    ...
    DevTensorDriftCheckSpec {
        ...
        path: "docs/reference/nuis-compiler-candidate-production-v8.toml",
        required_patterns: &[
            "nuis-compiler-candidate-production-v8",
    ...
    DevTensorDriftCheckSpec {
        ...
        required_patterns: &[
            ...
            "both driver and reproducibility gate to `usable/95`",
            "Data model v3 remains `usable/93`",
            "second-page identities `149528711957`",
            "and `146705724977`",
            "Token pagination, then map and arena growth",
        ],
    },
    DevTensorDriftCheckSpec {
