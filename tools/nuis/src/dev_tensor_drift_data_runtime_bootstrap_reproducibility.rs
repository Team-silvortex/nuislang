...
pub(crate) const DEV_TENSOR_RUNTIME_BOOTSTRAP_REPRODUCIBILITY_DRIFT_CHECKS:
    ...
    DevTensorDriftCheckSpec {
        ...
        required_patterns: &[
            "stage-neutral boundary to `usable/96`",
            "both driver and reproducibility gate at `usable/96`",
            "Data model v6 remains `usable/95`",
            "ordered identity `1064756829` at exit `130`",
            "Typed owned arena payloads",
        ],
    },
    DevTensorDriftCheckSpec {
