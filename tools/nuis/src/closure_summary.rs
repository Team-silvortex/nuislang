use crate::closure_summary_provider_completion::ProviderCompletionClosureMirror;
...
impl DebuggerCursorLineageClosureMirror {
    fn from_final_output(
        ...
        Self {
            ...
            provider_dispatch_identity_hash: final_output
...
impl FrontdoorClosureSummary {
    ...
    pub(crate) fn from_nsld_final_output_closure(
        ...
        if final_output.ready && final_output.nsdb_replay_ready {
            return Self {
                ...
                debugger_transcript_next_command: final_output
    ...
    fn with_final_output_closure_mirrors(
        ...
        self.debugger_transcript_next_command =
            final_output.debugger_transcript_next_command.clone();
    ...
    pub(crate) fn json_fields(&self) -> Vec<String> {
        let mut fields = vec![
            ...
            crate::json_optional_string_field(
                ...
                self.debugger_cursor_lineage
                    .as_ref()
                    .and_then(|mirror| mirror.provider_dispatch_identity_hash.as_deref()),
            ),
            crate::json_optional_string_field(
