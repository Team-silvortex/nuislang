...
pub(crate) const DEV_TENSOR_RUNTIME_DRIFT_CHECKS: &[DevTensorDriftCheckSpec] = &[
    ...
    DevTensorDriftCheckSpec {
        id: "project-status-link-plan-closure-summary",
        path: "tools/nuis/src/surface_render/project_status.rs",
        required_patterns: &[
            "project_status_closure_summary",
            "project-status-link-plan",
    ...
    DevTensorDriftCheckSpec {
            ...
            required_patterns: &[
                ...
                "real-device-provider-output-payload",
