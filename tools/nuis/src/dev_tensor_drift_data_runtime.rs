...
pub(crate) const DEV_TENSOR_RUNTIME_DRIFT_CHECKS: &[DevTensorDriftCheckSpec] = &[
    ...
    DevTensorDriftCheckSpec {
            ...
            required_patterns: &["collect_payload_decoder_manifest_mirror", "collect_backend_artifact_payload_evidence", "PayloadDecoderManifestMirror", "BackendArtifactPayloadEvidence"],
        },
    DevTensorDriftCheckSpec {
    ...
    DevTensorDriftCheckSpec {
            ...
            required_patterns: &["official_galaxy_hetero_projects_emit_shader_and_kernel_artifacts", "PixelMagicContracts.shader_pipeline_total", "WitSageContracts.kernel_pipeline_total", "hetero_runtime_trace_device_sample_descriptor_count"],
        },
    DevTensorDriftCheckSpec {
