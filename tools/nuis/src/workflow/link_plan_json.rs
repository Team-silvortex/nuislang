...
fn workflow_link_plan_json_fields(link_plan: Option<&nuisc::linker::LinkPlan>) -> Vec<String> {
    ...
    let mut fields = vec![
        ...
        crate::json_optional_string_field(
            ...
            closure_summary.debugger_cursor_handoff_contract.as_deref(),
        ),
        crate::json_optional_string_field(
            "closure_summary_debugger_cursor_path",
            closure_summary.debugger_cursor_path.as_deref(),
        ),
        crate::json_optional_bool_field(
            "closure_summary_debugger_cursor_ready",
            closure_summary.debugger_cursor_ready,
        ),
        crate::json_optional_string_field(
            "closure_summary_debugger_cursor_status",
            closure_summary.debugger_cursor_status.as_deref(),
        ),
        crate::json_optional_string_field(
            "closure_summary_debugger_cursor_next_command",
            closure_summary.debugger_cursor_next_command.as_deref(),
        ),
        crate::json_optional_string_field(
    ...
    closure_summary.append_projection_json_fields(&mut fields);
