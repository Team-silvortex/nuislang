...
pub(crate) const DEV_TENSOR_RUNTIME_EXECUTION_DRIFT_CHECKS: &[DevTensorDriftCheckSpec] = &[
    ...
    DevTensorDriftCheckSpec {
        ...
        DevTensorDriftCheckSpec {
            id: "official-pixelmagic-provider-graph-evidence",
        ...
        DevTensorDriftCheckSpec {
            id: "linux-cuda-host-probe-contract",
            path: "scripts/probe-linux-cuda-host.sh",
            required_patterns: &[
                "nuis-linux-cuda-host-probe-v1",
                "nvidia_driver_consistency_status",
                "driver-library-version-mismatch",
                "nvcc_role=development-validation-oracle-only",
                "ptx_compile_status",
                "nuis_probe_add",
                "cuda_runtime_status=launch-candidate",
                "ptx-ready-launch-blocked",
            ],
        },
        DevTensorDriftCheckSpec {
            id: "linux-cuda-runtime-vector-add-smoke",
            path: "tests/fixtures/cuda/vector_add_smoke.cu",
            required_patterns: &[
                "nuis-cuda-runtime-smoke-v1",
        ...
        DevTensorDriftCheckSpec {
            id: "kernel-cuda-hash-bound-ptx-sidecar",
            path: "tools/nuisc/src/aot_kernel_sidecar.rs",
            required_patterns: &[
                "select_kernel_code_asset",
                "asset.target",
                "asset.bytes",
                "source_fnv1a64",
                "ptx_body",
        ...
        DevTensorDriftCheckSpec {
            id: "linux-cuda-ptx-driver-smoke",
            path: "tests/fixtures/cuda/ptx_driver_smoke.cu",
            required_patterns: &[
                "nuis-cuda-ptx-driver-smoke-v1",
                "cuModuleLoad",
                "cuModuleGetFunction",
                "cuLaunchKernel",
                "output=11,22,33,44",
        ...
        DevTensorDriftCheckSpec {
            id: "nsdb-provider-code-asset",
            path: "tools/nsdb/src/provider_code_asset.rs",
            required_patterns: &[
                "nuis-provider-code-asset-descriptor-v1",
                "nuis-code-asset-digest-fnv1a64-v1",
                "relative_asset_path_is_valid",
                "ProviderCodeAssetDescriptor",
            ],
        },
        DevTensorDriftCheckSpec {
            id: "nsdb-cuda-provider-bundle",
        ...
        DevTensorDriftCheckSpec {
            id: "nsdb-cuda-execution-registration",
