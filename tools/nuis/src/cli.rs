...
pub enum CommandKind {
    ...
    BootstrapDispatchCompile(BootstrapComponentCompileDispatchInput),
    BootstrapDiff {
    ...
    I: Iterator<Item = String>,
{
    ...
    match command.as_str() {
        ...
        "bootstrap-dispatch-component" | "bootstrap-dispatch-compile" => {
            bootstrap_component::parse_bootstrap_component_dispatch(&command, &mut args)
        }
        "bootstrap-diff" => {
