...
pub(crate) fn print_help() {
    ...
    println!(
        "    nuis run-artifact [--json | --export-frame PATH | --window-session ID [--window-events CODEPOINTS]] <output-dir|binary-path|nuis.compiled.artifact|nuis.build.manifest.toml>"
    );
    println!(
