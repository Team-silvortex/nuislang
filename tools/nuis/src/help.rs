...
pub(crate) fn print_help() {
    ...
    println!("    nuis bootstrap-candidate-fresh-source <candidate-build-root> <candidate-successor> <source.ns> <fresh-source-result-output> <fresh-source-capability-output>");
