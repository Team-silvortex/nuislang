...
pub(crate) fn print_help() {
    ...
    println!(
        "    nuis run-artifact [--json | --export-frame PATH | --window-session ID [--window-events CODEPOINTS] [--window-parent-session ID] [--window-cancel-after-events [--drain-provider]]] <output-dir|binary-path|nuis.compiled.artifact|nuis.build.manifest.toml>"
    );
    println!(
    ...
    println!("    nuis bootstrap-candidate-fresh-source <candidate-build-root> <candidate-successor> <source.ns> <fresh-source-result-output> <fresh-source-capability-output> <nsld-input-output> <materialization-capability-output>");
    ...
    println!("    nuis bootstrap-dispatch-component <aggregate> <attestation> <attester-registry> <attester-registry-sha256> <attestation-challenge-sha256> <authorization> <authorizer-registry> <authorizer-registry-sha256> <authorization-challenge-sha256> <active-state> <transition> <transition-challenge-sha256> <current-component> <current-image> <forward-component> <forward-image> <output>");
    println!("    nuis bootstrap-dispatch-compile <aggregate> <attestation> <attester-registry> <attester-registry-sha256> <attestation-challenge-sha256> <authorization> <authorizer-registry> <authorizer-registry-sha256> <authorization-challenge-sha256> <active-state> <transition> <transition-challenge-sha256> <current-component> <current-image> <forward-component> <forward-image> <project> <fresh-build-output> <output>");
