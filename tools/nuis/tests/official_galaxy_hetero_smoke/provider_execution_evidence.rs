...
pub(super) fn assert_provider_execution_evidence(provider_output_payload_path: &Path) {
    for evidence in [
        ...
        "native_output_0_worker_adapter_control_contract = \"nuis-provider-worker-adapter-control-v1\"",
        ...
        "native_output_4_worker_execution_capsule_invocation_mode = \"worker-process-adapter-v4\"",
        "native_output_1_worker_execution_capsule_invocation_mode = \"worker-process-adapter-v4\"",
        "native_output_2_worker_execution_capsule_invocation_mode = \"worker-process-adapter-v4\"",
