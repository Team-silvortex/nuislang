...
* [hello_let_expr.ns](/Users/Shared/chroot/dev/nuislang/examples/ns/hello_let_expr.ns)
  `let` + arithmetic expression lowering
* [hello_struct.ns](/Users/Shared/chroot/dev/nuislang/examples/ns/hello_struct.ns)
...
* [hello_glm.ns](/Users/Shared/chroot/dev/nuislang/examples/ns/hello_glm.ns)
...
* [hello_data_window.ns](/Users/Shared/chroot/dev/nuislang/examples/ns/hello_data_window.ns)
...
* [host_ui_sphere.yir](/Users/Shared/chroot/dev/nuislang/examples/yir/host_ui_sphere.yir)
...
* [shader_texture_demo.yir](/Users/Shared/chroot/dev/nuislang/examples/yir/shader_texture_demo.yir)
...
* [kernel_topk_axis_demo.yir](/Users/Shared/chroot/dev/nuislang/examples/yir/kernel_topk_axis_demo.yir)
...
* [cpu_linked_list_rustish.yir](/Users/Shared/chroot/dev/nuislang/examples/yir/cpu_linked_list_rustish.yir)
  current Rust-ish CPU ownership model
* [cpu_types_struct.yir](/Users/Shared/chroot/dev/nuislang/examples/yir/cpu_types_struct.yir)
...
* [hello_bad_unit.ns](/Users/Shared/chroot/dev/nuislang/examples/invalid/ns/hello_bad_unit.ns)
  invalid unit not registered by the selected `nustar`
* [hello_glm_invalid.ns](/Users/Shared/chroot/dev/nuislang/examples/invalid/ns/hello_glm_invalid.ns)
  invalid ownership use
* [hello_ref_struct_invalid.ns](/Users/Shared/chroot/dev/nuislang/examples/invalid/ns/hello_ref_struct_invalid.ns)
  invalid consume of a borrowed `struct` field
* [hello_nested_mod_invalid.ns](/Users/Shared/chroot/dev/nuislang/examples/invalid/ns/hello_nested_mod_invalid.ns)
...
Built single-binary example artifacts are placed under:
...
* [examples/bins/window_controls_demo/window_controls_demo](/Users/Shared/chroot/dev/nuislang/examples/bins/window_controls_demo/window_controls_demo)
  current single-binary macOS `cpu + data + shader` window demo
* [examples/bins/window_controls_demo_ns/window_controls_demo](/Users/Shared/chroot/dev/nuislang/examples/bins/window_controls_demo_ns/window_controls_demo)
  same control/render path built from `.ns` instead of handwritten `YIR`
* [examples/bins/window_controls_demo_project/window_controls_demo](/Users/Shared/chroot/dev/nuislang/examples/bins/window_controls_demo_project/window_controls_demo)
  same control/render path built from a multi-file `nuis` project
